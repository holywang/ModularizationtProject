...
import com.holy.modularizationtproject.component.utils.UIUtil;
...
public class LeafLoadingView extends View{
    ...
    private void initBitmap() {
        mLeafBitmap = ((BitmapDrawable) mResources.getDrawable(R.drawable.leaves)).getBitmap();
    ...
    private class Leaf{
        ...
        int rotateDirection;//旋转方向 0顺时针 1逆时针
        long startTime;//起始时间ms
        StartType type;//叶子飘动的幅度
    }
    ...
    private class LeafFactory {
        ...
        public Leaf generateLeaf(){
            ...
            switch (randomType){
                case 0:break;
                case 1: type = StartType.LITTLE;break;
                case 2: type = StartType.BIG;break;
                default:break;
            }
            leaf.type = type;
